...
use LaravelClass\LaraAuth\Middleware\LaraAuthResetPassword;
use LaravelClass\LaraAuth\Middleware\LaraAuthVerifyEmail;
...
class LaraAuthProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        app('router')->aliasMiddleware('laraAuthEmail',LaraAuthVerifyEmail::class);

        app('router')->aliasMiddleware('laraAuthResetPassword',LaraAuthResetPassword::class);
